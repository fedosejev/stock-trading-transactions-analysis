  ...
  render: function () {
    return (
      <form onSubmit={this.handleSubmitEvent} className="robinhood-login-form">
        ...
        <p className="not-saving-login-message">We <strong>do not</strong> store your username and/or password. This is an open source project - you're welcome to inspect the source code <a href="https://github.com/fedosejev/stock-trading-transactions-analysis" target="_blank">here</a>.</p>
